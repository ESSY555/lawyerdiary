        ...
        <div class="space-y-4 sm:space-y-5">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6">
                ...
                <a href="{{ route('dashboard.cases') }}"
                    class="group relative overflow-hidden rounded-xl bg-white p-6 shadow-lg hover:shadow-2xl transition-all duration-300 border border-gray-100 hover:-translate-y-1 cursor-pointer block">
                    <div
                        class="absolute top-0 right-0 w-32 h-32 bg-gradient-to-br from-[#4338ca]/10 to-[#6366f1]/5 rounded-full -mr-16 -mt-16">
                    </div>
                    <div class="relative">
                ...
                <a href="{{ route('dashboard.clients') }}"
                    class="group relative overflow-hidden rounded-xl bg-white p-6 shadow-lg hover:shadow-2xl transition-all duration-300 border border-gray-100 hover:-translate-y-1 cursor-pointer block">
                    <div
                        class="absolute top-0 right-0 w-32 h-32 bg-gradient-to-br from-[#16a34a]/10 to-[#22c55e]/5 rounded-full -mr-16 -mt-16">
                    </div>
                    <div class="relative">
                        <div class="flex items-center justify-between mb-4">
                ...
                <a href="{{ route('dashboard.hearings') }}"
                    class="group relative overflow-hidden rounded-xl bg-white p-6 shadow-lg hover:shadow-2xl transition-all duration-300 border border-gray-100 hover:-translate-y-1 cursor-pointer block">
                    <div
                        class="absolute top-0 right-0 w-32 h-32 bg-gradient-to-br from-[#f97316]/10 to-[#fb923c]/5 rounded-full -mr-16 -mt-16">
                    </div>
                    <div class="relative">
                        <div class="flex items-center justify-between mb-4">
                ...
                <a href="{{ route('dashboard.notes') }}"
                    class="group relative overflow-hidden rounded-xl bg-white p-6 shadow-lg hover:shadow-2xl transition-all duration-300 border border-gray-100 hover:-translate-y-1 cursor-pointer block">
                    <div
                        class="absolute top-0 right-0 w-32 h-32 bg-gradient-to-br from-[#ef4444]/10 to-[#f87171]/5 rounded-full -mr-16 -mt-16">
                    </div>
                    <div class="relative">
                        <div class="flex items-center justify-between mb-4">
                    ...
                    <div class="bg-white rounded-xl shadow-lg border border-gray-100 overflow-hidden">
                        <div class="bg-gradient-to-r from-[#f97316] to-[#fb923c] px-6 py-4">
                            <div class="flex items-center justify-between">
                                ...
                                <a href="{{ route('dashboard.hearings') }}"
                                    class="text-sm font-medium text-white hover:text-orange-100 transition-colors">View All →</a>
                            </div>
                        </div>
                        <div class="p-6">
                            <div class="flex flex-col items-center justify-center py-12 text-center">
                                ...
                                <a href="{{ route('dashboard.hearings') }}">
                                    <x-ui.button variant="default"
                                        class="bg-gradient-to-r from-[#f97316] to-[#fb923c] hover:from-[#fb923c] hover:to-[#fdba74] text-white border-0">
                        ...
                        <div class="px-6 py-4 border-b border-gray-100">
                            <div class="flex items-center justify-between">
                                ...
                                <div class="flex items-center gap-2">
                                    <button
                                        class="text-xs px-3 py-1 bg-gray-100 hover:bg-gray-200 rounded-lg font-medium text-gray-700 transition-colors">6M</button>
                                    <button
                                        class="text-xs px-3 py-1 bg-blue-50 text-blue-600 rounded-lg font-medium transition-colors">1Y</button>
                                </div>
                            </div>
                        </div>
                        <div class="p-6">
                    ...
                    <div class="bg-white rounded-xl shadow-lg border border-gray-100 overflow-hidden">
                        <div class="px-6 py-4 border-b border-gray-100">
                            <div class="flex items-center justify-between">
                                ...
                                <a href="#" class="text-sm font-medium text-[#4338ca] hover:text-[#6366f1] transition-colors">View
                                    All →</a>
                            </div>
                            </div>
                            <div class="p-6">
                                    ...
                                    <div class="space-y-6">
                                        ...
                                        <div class="bg-white rounded-xl shadow-lg border border-gray-100 overflow-hidden">
                                            ...
                                            <div class="p-4 space-y-2">
                                                <a href="{{ route('dashboard.cases') }}"
                                                    class="flex items-center gap-3 p-3 rounded-lg hover:bg-gradient-to-r hover:from-blue-50 hover:to-purple-50 transition-all group cursor-pointer">
                                                ...
                                                <a href="{{ route('dashboard.clients') }}"
                                                    class="flex items-center gap-3 p-3 rounded-lg hover:bg-gradient-to-r hover:from-green-50 hover:to-emerald-50 transition-all group cursor-pointer">
                                                ...
                                                <a href="{{ route('dashboard.hearings') }}"
                                                    class="flex items-center gap-3 p-3 rounded-lg hover:bg-gradient-to-r hover:from-orange-50 hover:to-amber-50 transition-all group cursor-pointer">
                                                ...
                                                <a href="{{ route('dashboard.notes') }}"
                                                    class="flex items-center gap-3 p-3 rounded-lg hover:bg-gradient-to-r hover:from-purple-50 hover:to-pink-50 transition-all group cursor-pointer">
